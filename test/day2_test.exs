defmodule AdventOfCode.Day2Test do
  ...
  test "solves a small example" do
    ...
    assert @module.points_part1(input) == 15
  end

  test "it solves part 1 with the correct solution of 11603" do
    input = File.read!("test/day2_part1.txt")

    assert @module.points_part1(input) == 11603
  end

  test "it solves part 1 with the correct solution of 12725" do
    input = File.read!("test/day2_part1.txt")

    assert @module.points_part2(input) == 12725
  end
end